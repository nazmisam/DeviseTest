...
class SplitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create split" do
    assert_difference("Split.count") do
      post splits_url, params: { split: { account: @split.account, product_id: @split.product_id, split_percent: @split.split_percent } }
    end
  ...
  test "should update split" do
    patch split_url(@split), params: { split: { account: @split.account, product_id: @split.product_id, split_percent: @split.split_percent } }
